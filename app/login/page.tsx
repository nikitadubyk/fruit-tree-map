...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 bg-[url('/auth-background.jpg')] bg-no-repeat bg-center bg-cover">
